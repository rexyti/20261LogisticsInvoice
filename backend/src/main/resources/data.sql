...
VALUES ('55555555-5555-5555-5555-555555555555', 'aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', '11111111-1111-1111-1111-111111111111', 'CAMION', 'REPARTO', '2024-05-20 08:00:00', '2024-05-20 18:00:00', 'OK')
ON CONFLICT DO NOTHING;
...
INSERT INTO parada (id, paquete_id, parada_id, ruta_entity_id, estado, motivo_falla) VALUES
    ('66666666-6666-6666-6666-666666666661', 'aaaaaaaa-0000-0000-0000-000000000001', 'bbbbbbbb-0000-0000-0000-000000000001', '55555555-5555-5555-5555-555555555555', 'EXITOSA', NULL),
    ('66666666-6666-6666-6666-666666666663', 'aaaaaaaa-0000-0000-0000-000000000003', 'bbbbbbbb-0000-0000-0000-000000000003', '55555555-5555-5555-5555-555555555555', 'FALLIDA', 'DIRECCION_ERRONEA')
ON CONFLICT DO NOTHING;
...
INSERT INTO vehiculos (id_vehiculo, id_transportista, tipo) VALUES
    ('11111111-1111-1111-1111-111111111111', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', 'VAN')
ON CONFLICT DO NOTHING;
...
VALUES ('44444444-4444-4444-4444-444444444444', 'POR_PARADA', 150.0000, 'CONTR-001', 'PARADA', true, 150.00, NULL, 'VAN', '2024-01-01 00:00:00', '2024-12-31 23:59:59', 'a1b2c3d4-e5f6-7890-1234-567890abcdef', '33333333-3333-3333-3333-333333333333')
ON CONFLICT DO NOTHING;
...
VALUES ('55555555-5555-5555-5555-555555555555', '2024-05-20 08:00:00', '2024-05-20 18:00:00', 'MOTO', 150.00, 3)
ON CONFLICT DO NOTHING;
...
VALUES ('77777777-7777-7777-7777-777777777777', '55555555-5555-5555-5555-555555555555', '44444444-4444-4444-4444-444444444444', 'CALCULADA', 300.0000, 350.0000, NOW(), true, NOW(), NOW(), 'APROBADA', 300.00, 350.00, 'a1b2c3d4-e5f6-7890-1234-567890abcdef')
ON CONFLICT DO NOTHING;
...
VALUES ('88888888-8888-8888-8888-888888888888', '77777777-7777-7777-7777-777777777777', 'BONO', 50.0000, 'Bono por buen servicio', NOW(), NOW())
ON CONFLICT DO NOTHING;

-- ============================================================
-- 10. PAQUETES / HISTORIAL
-- ============================================================
INSERT INTO paquetes (id_paquete, id_ruta, estado_actual, updated_at)
VALUES ('cccccccc-0000-0000-0000-000000000101', '55555555-5555-5555-5555-555555555555', 'ENTREGADO', NOW())
ON CONFLICT DO NOTHING;

INSERT INTO historial_estados (id_paquete, estado, fecha)
VALUES ('cccccccc-0000-0000-0000-000000000101', 'ENTREGADO', '2024-05-20 14:00:00')
ON CONFLICT DO NOTHING;
