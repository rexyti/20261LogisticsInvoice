...
@NoArgsConstructor
@AllArgsConstructor
public class CierreRutaRutaEntity {
    ...
    @Builder.Default
    private List<CierreRutaParadaEntity> paradas = new ArrayList<>();

    public void addParada(CierreRutaParadaEntity parada) {
    ...
    public void setParadas(List<CierreRutaParadaEntity> paradas) {
        this.paradas.clear();
        if (paradas != null) {
