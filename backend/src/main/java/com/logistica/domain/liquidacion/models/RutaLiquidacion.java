...
public class RutaLiquidacion {
    ...
    public static class RutaLiquidacionBuilder {
        public RutaLiquidacion build() {
            ...
            return new RutaLiquidacion(id, fechaInicio, fechaCierre, paquetes);
        }
    }

    private RutaLiquidacion(UUID id, OffsetDateTime fechaInicio, OffsetDateTime fechaCierre, List<Paquete> paquetes) {
        this.id = id;
