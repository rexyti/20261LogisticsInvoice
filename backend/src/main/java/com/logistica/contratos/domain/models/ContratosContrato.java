...
@Getter
@Builder
public class ContratosContrato {
    private UUID id;
    private String idContrato;
    private String tipoContrato;
    private ContratosTransportista transportista;
    ...
    public static ContratosContrato crear(
            String idContrato,
            String tipoContrato,
            ContratosTransportista transportista,
            ContratosTipoVehiculo tipoVehiculo,
            Boolean esPorParada,
