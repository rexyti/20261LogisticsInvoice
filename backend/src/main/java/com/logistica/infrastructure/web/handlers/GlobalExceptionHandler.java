...
import com.logistica.shared.exceptions.EventoDuplicadoException;
import com.logistica.shared.exceptions.EventoPagoNoProcesableException;
import com.logistica.shared.exceptions.LiquidacionNoEncontradaException;
import com.logistica.shared.exceptions.PagoNoEncontradoException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleEventoDuplicado(EventoDuplicadoException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT).body(Map.of(
                "timestamp", Instant.now().toString(),
    ...
    public ResponseEntity<Map<String, Object>> handleMessageNotReadable(HttpMessageNotReadableException ex) {
        String mensaje = ex.getMessage() != null && ex.getMessage().contains("EstadoPagoEnum")
