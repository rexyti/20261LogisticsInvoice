package com.logistica.infrastructure.liquidacion.web.handlers;
...
public class LiquidacionGlobalExceptionHandler {
    ...
    @ExceptionHandler(ContratoTarifaNoEncontradaException.class)
    public ResponseEntity<ProblemDetail> handleContratoNotFound(ContratoTarifaNoEncontradaException ex) {
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(DuplicadaException.class)
    public ResponseEntity<ProblemDetail> handleLiquidacionDuplicada(DuplicadaException ex) {
