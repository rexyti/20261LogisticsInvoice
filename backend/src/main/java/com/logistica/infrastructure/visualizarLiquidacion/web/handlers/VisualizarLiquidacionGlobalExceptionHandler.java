package com.logistica.infrastructure.visualizarLiquidacion.web.handlers;
...
public class VisualizarLiquidacionGlobalExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(VisualizarLiquidacionGlobalExceptionHandler.class);
    ...
    public ResponseEntity<ErrorResponseDTO> handleValidation(BindException ex) {
