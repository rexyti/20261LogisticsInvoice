package com.logistica.VisualizarEstadoPago.infrastructure.web.handlers;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handlePagoNoEncontradoException(PagoNoEncontradoException ex, WebRequest request) {
