...
public class VisualizarEstadoPagoPago {
    ...
    public VisualizarEstadoPagoPago() {
    }

    public VisualizarEstadoPagoPago(UUID id, UUID usuarioId, BigDecimal montoBase, LocalDateTime fecha, UUID penalidadId, BigDecimal montoNeto, UUID liquidacionId, VisualizarEstadoPagoEstadoPagoEnum estado) {
        this.id = id;
