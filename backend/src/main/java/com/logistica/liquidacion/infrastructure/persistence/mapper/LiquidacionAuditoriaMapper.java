...
@Component
public class LiquidacionAuditoriaMapper {

    /**
     * Crea una nueva entidad de auditoría desde el modelo de dominio.
     */
    public LiquidacionAuditoriaEntity toEntity(AuditoriaLiquidacion model) {
        if (model == null) return null;

        LiquidacionAuditoriaEntity entity = new LiquidacionAuditoriaEntity();
     ...
     */
    public AuditoriaLiquidacion toModel(LiquidacionAuditoriaEntity entity) {
